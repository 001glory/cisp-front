<template>
  <el-form ref="form" :model="formData" label-width="80px" style="width:400px;margin:auto;margin-top:50px">
    ...
    <el-form-item label="通知标题">
      <el-input v-model="formData.emerTitle" placeholder="通知标题(30个字符)" maxlength="30"></el-input>
    </el-form-item>
    <el-form-item label="文本信息">
      <el-input v-model="formData.emerContent" type="textarea" :rows="3" placeholder="请输入内容(255个字符)"></el-input>
    </el-form-item>
    <el-form-item>
